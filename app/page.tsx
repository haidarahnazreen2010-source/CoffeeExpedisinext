    ...
    <div className="relative min-h-screen bg-[#1A0F0A] text-[#FDF5E6] font-sans overflow-hidden">
      ...
      <nav className="relative z-20 w-full h-20 md:h-24 border-b border-white/5 bg-[#1A0F0A]/60 backdrop-blur-md">
        ...
        <div className="w-full h-full flex items-center justify-between px-8 md:px-16 lg:px-24">
          ...
          {/* Right: Utilities (Shrunk and shifted left) */}
          <div className="w-1/3 flex justify-end items-center h-full gap-6 lg:gap-8 text-xs lg:text-sm font-bold tracking-wider uppercase">
            <Link href="#" className="hidden lg:flex items-center justify-center px-5 py-2 border-2 border-[#E77D13] text-[#E77D13] rounded-full hover:bg-[#E77D13] hover:text-white transition-all duration-300">
              Login
            </Link>
